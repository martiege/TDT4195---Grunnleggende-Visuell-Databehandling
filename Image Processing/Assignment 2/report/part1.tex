...
% Final Train loss: 0.06584324309183384. Final Train accuracy: 0.9777166666666667
...
\subsubsection*{c)}
See \cref{fig:task2c} for the plot of the cross entropy loss for the test and training data. The final validation loss was calculated as $0.023527828954214854$, and the final validation accuracy was calculated as $0.9917$. The final training loss was calculated as $0.011397973218215578$, and the final training accuracy was calculated as $0.9968666666666667$. 

Again, as above, we can notice overfitting when training loss is a lot smaller than validation loss. In this case, there seems to be evidence of overfitting, as the validation loss seems to be about double the training loss. This may not be significant enough, depending on the application of this neural network, but there is still more evidence of overfitting in this task than the previous. 
