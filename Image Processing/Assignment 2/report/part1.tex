...
\subsection*{d)}
If we start with subsampling with neighbourhoods of size $2x2$ and stride 2, then we'd decrease the width and height by half. Then, using the same information utilized above, we define: 
...
Then the spatial dimensions of the pooled feature maps in the first layer would be $248x248$. 
