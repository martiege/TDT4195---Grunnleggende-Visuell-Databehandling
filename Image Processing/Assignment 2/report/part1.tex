...
Then we calculate the spatial dimensions of the different layers (this wasn't strictly needed to calculate the number of parameters, but was useful for task 2): 
\begin{align*}
