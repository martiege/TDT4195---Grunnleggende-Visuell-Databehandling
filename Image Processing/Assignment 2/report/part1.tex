...
Using zero-padding for this convolution. I flipped the kernel and used correlation and matrix multiplication to get the convolution. Convolving I and K by correlating each of the pixels of the zero-padded image with the flipped kernel. See \cref{fig:kernel_convolution}: 
