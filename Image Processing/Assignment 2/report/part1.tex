...
Again, as above, we can notice overfitting when training loss is a lot smaller than validation loss. In this case, there seems to be evidence of overfitting, as the validation loss seems to be about double the training loss. 
